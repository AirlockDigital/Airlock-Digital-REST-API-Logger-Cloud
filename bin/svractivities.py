...
import input_module_svractivities as input_module
...
'''
    ...
    Add your modular input logic to file input_module_svractivities.py
'''
class ModInputsvractivities(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputsvractivities, self).__init__("ta_airlock_digital_rest_api_logger_cloud", "svractivities", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputsvractivities, self).get_scheme()
        scheme.title = ("svractivities")
...
if __name__ == "__main__":
    exitcode = ModInputsvractivities().run(sys.argv)
    sys.exit(exitcode)
